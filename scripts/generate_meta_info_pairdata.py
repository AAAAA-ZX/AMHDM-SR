...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=['datasets/DIV2K_train_HR/DIV2K_train_HR_sub', 'datasets/DIV2K_train_HR/DIV2K_train_LR_bicubic_X4_sub'],
    ...
    parser.add_argument(
        '--meta_info',
        type=str,
        default='datasets/DIV2K_train_HR/meta_info/meta_info_DIV2K_sub_pair.txt',
