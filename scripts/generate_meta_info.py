...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=['datasets/DIV2K_train_HR', 'datasets/DIV2K_train_HR_multiscale'],
        help='Input folder, can be a list')
    parser.add_argument(
        '--root',
        nargs='+',
        default=['DIV2K_train_HR', 'DIV2K_train_HR'],
        help='Folder root, should have the length as input folders')
    parser.add_argument(
        '--meta_info',
        type=str,
        default='datasets/DIV2K_train_HR/meta_info_DIV2K_train_HR_multiscale.txt',
